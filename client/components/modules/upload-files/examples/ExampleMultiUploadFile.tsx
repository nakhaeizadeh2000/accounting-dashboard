...
import { FileUploadInfo } from '../utils/file-types';

/**
 * Example component demonstrating how to use MultiFileUpload
 */
const ExampleMultiUploadFile = () => {
  ...
  /**
   * Handle completion of all uploads (including failures)
   */
